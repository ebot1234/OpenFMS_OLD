Public Class Utilities
    ...
    Dim Access_Piont_1 As String
    Dim red_ViewMarq_1 As String
    Dim blue_viewmarq_1 As String
    Dim light_controller_1 As String = "13"

    Private Sub Utilities_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        If My.Computer.Network.Ping(AdminNetwork & FMS_PC, 1000) Then
            FMS.ForeColor = Color.LimeGreen
        Else : FMS.ForeColor = Color.Red
        End If
