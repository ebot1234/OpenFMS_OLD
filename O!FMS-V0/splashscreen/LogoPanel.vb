...
Public Class LogoPanel
    ...
    '    Console.Out.Write(("Height: " + jLabel1.getIcon.getIconHeight))
    '    ' getHeight());
    ...
    '    Console.Out.Write(("Width: " + Label1.getIcon.getIconWidth))
    '    Dim width As Integer = Label1.getIcon.getIconWidth
    ...
    'Private Label1 As javax.swing.JLabel

    'Private Label2 As javax.swing.JLabel
End Class