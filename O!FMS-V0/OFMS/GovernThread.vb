...
Public Class GovernThread
    ...
    '  MyBase.New()
    ' Console.Out.Write("GovernThread Constructor")
    ' Me.gameUi = Me.gameUi
    ' Me.field = Me.field
    ' End Sub
    ...
    '        _instance.kill = True
    '        Console.Out.Write(("Asked for a new instance of GT, had one already, " + "killing the existing instance first..."))
    ...
    '        Console.Out.Write("...existing instance has died, creating new.")
    '    End If
    ...
    Public Shared Function getInstance() As GovernThread
        If (_instance Is Nothing) Then
            Console.Out.Write(("Asked for GovernThread instance before " + "it was properly created; returning null!!"))
        End If
    ...
    Public Sub start()
        If (Me.gameUi Is Nothing) Then
            Console.Out.Write("Invalid GovernThread - No OFMS_UI!!")
        ElseIf (Me.field Is Nothing) Then
            Console.Out.Write("Invalid GovernThread - No FieldAndRobots!!")
        ElseIf Me.newMatch Then
            '      MyBase.start()
        Else
            Console.Out.Write("************ERROR - THIS IS NOT A NEW MATCH**********")
        End If
    ...
    Public Sub run()
        ...
        Console.Out.Write("Warmup Start")
        ...
        While Not Me.kill
            ...
            If (Me.pseudoTimeMillis <= Me.getTotalTimeMillis) Then
                ...
                ' UI_Layer.getInstance.setMatchTime(Me.fixTime(((Me.currMatchTimeMillis / 1000) + "")))
            Else
                Me.stopMatch()
            End If
        ...
        Console.Out.Write("Autonomous Start")
        ...
        While Not Me.kill
            ...
            Try
                ...
                'Me.sleep(100)
            Catch ex As NotSupportedException
                'Logger.getLogger(GovernThread.getName).log(Level.SEVERE, Nothing, ex)
            End Try
    ...
    Public Sub emergencyStopMatch()
        Console.Out.Write("Match Emergency Stopped!!!")
        Me.stopMatch()
        ' Me.playSound("FOGHORN.wav")
    End Sub

    Public Sub stopMatch()
        Console.Out.Write("Match Ended")
    ...
    Private Shared Sub getRandomItem(ByVal gameData As List(Of String))
        ...
        'Console.Out.Write(("" + gameData.get(index)))
    End Sub
