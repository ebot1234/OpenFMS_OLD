...
Public Class Team
    ...
    Public Sub New(ByVal number As Integer, ByVal alliance As Integer, ByVal station As Integer)
        MyBase.New()
        System.Console.Write("Team Constructor")
        Me.teamNum = number
    ...
    Public Sub setTeamNumber(ByVal number As Double)
        ...
        Dim teamIP As String = ("10." _
                    ...
                    + (last + ".5"))))
        'Try
        'Me.addr = Net.IPAddress.getByName(teamIP)
    ...
    Public Function getInetAddress() As Net.IPAddress
        Return Me.addr
    End Function
