...
Imports O_FMS_V0.Seesaw

Imports O_FMS_V0.Scoring
Public Class FieldAndRobots
    ...
    '    teamsPerAlliance()
    '    Console.Out.Write("FieldAndRobots Contructor")
    '    Console.Out.Write("Initializing Teams...")
    ...
    Public Shared Function getNewInstance(ByVal allianceCount As Integer, ByVal teamsPerAlliance As Integer) As FieldAndRobots
        If (Not (_instance) Is Nothing) Then
            Console.Out.Write(("Asked for a new instance of FAR, had one already, " + "throwing it away."))
        End If

        If (allianceCount = 0) Then
            Console.Out.Write(("Defaults triggered: using 2 alliances with " + "three teams each."))
            allianceCount = 2
            teamsPerAlliance = 3
        End If

        _instance = New FieldAndRobots()
        Return _instance
    End Function
    ...
    '        Next
    '    Next
    '    Console.Out.Write("Finished Starting Team FMS Updates...")
    'End Sub
    ...
    Public Function randomize(ByVal lst As ICollection(Of String)) As String
        ...
        Dim gamedata As New List(Of String)(lst)
        gamedata.Add("LLL")
        gamedata.Add("RRR")
        gamedata.Add("LRL")
        gamedata.Add("RLR")
        Return gamedata(rdm.Next(0, lst.Count))
    End Function
    ...
    '        Next
    '    Next
    '    Console.Out.Write("Bypassing in FAR done...")
    'End Sub
    ...
    '        Next
    '    Next
    '    Console.Out.Write("Resetting in FAR done...")
    'End Sub
    ...
    '    Else
    '        Console.Out.Write("SetTeamNumber Error!")
    '    End If
    ...
    '        Else
    '            Console.Out.Write("INCORRECT STATE(in actOnRobot): NOTHING DONE")
    '        End If

    '    Else
    '        Console.Out.Write("ActOnRobot Verification Error!")
    '    End If
