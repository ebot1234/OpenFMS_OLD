...
Public Class DSSender
    ...
    Public Shared Function getInstance() As DSSender
        If (_instance Is Nothing) Then
            ...
            Console.Out.Write("DSSender Constructed")
        End If
    ...
    Private Function buildGameSpecificDataPacket(ByVal addr As Net.IPAddress, ByVal game As Byte) As DatagramPacket
    ...
    Private Function buildPacket(ByVal addr As Net.IPAddress, ByVal robotState As Byte, ByVal allianceColor As Byte, ByVal station As Byte) As DatagramPacket
        ' Create array
