...
Imports Communication.DSReceiver
Imports PLC_Aux.PLC_Receiver
Imports PLC_Aux.PLC_Sender
...
Imports splashscreen.FMS_SplashScreen
Public Class Main

    '<editor-fold defaultstate="collapsed" desc="Variables">
    Public Shared layer As UI_Layer
    ...
    Private Sub New()
        ...
        Else
            ...
            System.out.println("********ERROR - NewUI IS NULL; GETTING INSTANCE"& vbLf& vbLf& vbLf& vbLf)
        End If
        ...
        Dim {(,) As String
        Dim teams(,) As String = New String() {{, "0001", "0002", "0003",
        "0004",
        "0005",
        "0006"}
    End Sub
